...
pub fn run() {
    ...
    let app = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::library_favorites::list_favorite_characters,
            commands::library_favorites::add_favorite_character,
            commands::library_favorites::update_favorite_character,
            commands::library_favorites::remove_favorite_character,
            commands::library_favorites::relink_favorite_character,
            commands::library_favorites::add_tags_to_favorite_character,
            commands::library_favorites::remove_tag_from_favorite_character,
            commands::library_favorites::set_favorite_character_tags,
            commands::library_favorites::list_favorite_character_tags,
            commands::library_favorites::list_favorite_artists,
            commands::library_favorites::add_favorite_artist,
            commands::library_favorites::update_favorite_artist,
