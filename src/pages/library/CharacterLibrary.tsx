...
import type { Character } from "../../stores/libraryStore";
    ...
    <div className="flex flex-col h-full gap-4">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-[var(--text-muted)] text-sm">海量角色库，支持一键加入提示词</p>
        </div>
      ...
      <div className="flex-1 min-h-0 relative">
        {isCharactersLoading && characters.length === 0 ? (
          ...
          <div className="h-full flex flex-col items-center justify-center gap-3 text-[var(--text-muted)]">
            ...
            <span className="text-sm">没有角色数据</span>
          ...
          itemContent={(index, character) => (
            ...
            >
              ...
              <div className="absolute bottom-0 inset-x-0 p-3 pt-6 flex flex-col justify-end">
                ...
                {character.copyright && (
                  <div className="text-[var(--accent-1)] text-[10px] uppercase tracking-wider mt-1 truncate">
                    {character.copyright.replace(/_/g, " ")}
                  </div>
                )}
              </div>
            </div>
